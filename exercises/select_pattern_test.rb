...
class SelectPatternTest < Minitest::Test
  ...
  def test_pick_words_with_three_letters
    ...
    selected = []
    words.each {|word| selected << word if word.size == 3 }
  ...
  def test_pick_words_ending_in_e
    ...
    selected = []
    words.each{|word| selected << word if word.split('').last == "e" }
  ...
  def test_pick_words_ending_in_ing
    ...
    selected = []
    words.each{|word| selected << word if word.split('')[-3..-1].join('') == 'ing'}
