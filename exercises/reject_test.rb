...
class RejectTest < Minitest::Test
  ...
  def test_remove_animals_starting_with_vowels
    ...
    remaining = animals.reject{|animal| %W[a e i o u].include?(animal.split('').first)}
